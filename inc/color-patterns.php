 ...
 */
function foodordering_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'foodordering_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.foodordering-front-page) .entry-title,
...
.colors-custom .foodordering-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.foodordering-front-page .panel-content .recent-posts article,
...
.colors-custom.foodordering-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'foodordering_custom_colors_css', $css, $hue, $saturation );
}
